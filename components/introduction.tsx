...
const Introduction = () => {
    return (
        <div className="relative z-20 w-full min-h-[115vh] md:min-h-screen flex items-start md:items-center bg-darkBg">
            <div className="w-full grid items-center h-full px-4 sm:px-6 pt-32 pb-24 md:py-0 md:grid-cols-2 gap-6 md:gap-8">
                {/* Image Section */}
                ...
                <div className="flex flex-col justify-center items-center md:items-start max-w-lg mx-auto md:mx-0 order-2 md:order-2">
                    ...
                    {/* CTA Buttons */}
                    <div className="relative z-10 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 md:justify-start w-full sm:w-auto">
                        <Link
                            href="/portfolio"
            ...
            <div className="hidden sm:flex absolute bottom-8 left-1/2 -translate-x-1/2 flex-col items-center gap-2 text-gray-400 animate-bounce">
