...
const TimeLine = () => {
    return (
        <div className="flex flex-col justify-center divide-y divide-slate200">
                ...
                <div className="-my-6">
                    {dataAboutPage.map((data) => (
                        ...
                        >
                            ...
                            >
                                <time className="sm:absolute left-0 translate-y-0.5 inline-flex items-center justify-center text-xs font-semibold uppercase w-23 h-9 mb-3 sm:mb-0 text-emerald-600 bg-emerald-100 rounded-full p-2">
                                    {data.date}
                                </time>
